...
myTreeSupport_Sep <- getAlignmentSupport(tree = myTree,signal = mySignals,include_root = TRUE)

# Get tree support, summed across alignments
myTreeSupport_Sum <- getAlignmentSupport(tree = myTree,signal = mySignals,include_root = TRUE,separate_signal = FALSE)
